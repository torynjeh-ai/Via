...
const en = {
  ...
  fullName: 'Full Name', passwordOptional: 'Password (optional)', passwordHint: 'Min 6 characters',
...
const fr = {
  ...
  fullName: 'Nom complet', passwordOptional: 'Mot de passe (optionnel)', passwordHint: 'Min 6 caractères',
...
const pt = {
  ...
  fullName: 'Nome completo', passwordOptional: 'Senha (opcional)', passwordHint: 'Mín. 6 caracteres',
...
const sw = {
  ...
  fullName: 'Jina Kamili', passwordOptional: 'Nenosiri (hiari)', passwordHint: 'Herufi 6 au zaidi',
